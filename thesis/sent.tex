...
The effect of increased sensitivity in semantically predictable sentences to the signal properties found in the phoneme restoration literature \citep{Samuel1981} could lead to one of two outcomes.
...
On the other hand, the lower cognitive load could lead to more attention available to notice the deviant production, and thus behave more like the participants in Experiment 2.
